...
namespace QuanLyNhaSach_DoAn
{
    public class XuLy
    {
        ...
        SqlConnection cnn = new SqlConnection("Data Source=ASUS-00I\\SQLEXPRESS;Initial Catalog=QL_NHASACHREAL;Integrated Security=True");
        ...
        {
            SqlDataAdapter ds_SPsach = new SqlDataAdapter("select masach,tensach,gia,soluong from SACH", cnn);
        ...
        public void ThemCTHD(DataGridView pdg, string mahd)
        {
